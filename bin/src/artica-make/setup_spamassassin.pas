...
begin
   ...
   install.INSTALL_PROGRESS(CODE_NAME,'{downloading}');
    CODE_NAME:='APP_FUZZYOCR';
    libs.PERL_GENERIC_INSTALL('MLDBM-Sync','MLDBM::Sync');
    writeln('Checking Artica repository');
   if length(source_folder)=0 then source_folder:=libs.COMPILE_GENERIC_APPS('fuzzyocr');
   writeln('Checking directory "',source_folder,'"');
   ForceDirectories('/etc/spamassassin');
   fpsystem('cp -rfu '+source_folder+'/FuzzyOcr* /etc/spamassassin/');

   if FileExists('/etc/spamassassin/FuzzyOcr/Config.pm')  then begin
...
procedure tspam.minium_require();
begin
...
begin
    ...
    writeln('Checking ENV');
    fpsystem('/usr/bin/env 2>&1');
  ...
  if not DirectoryExists(source_folder) then begin
     writeln('Install '+CODE_NAME+' failed, unable to stat Mail-SpamAssassin in repository...');
     install.INSTALL_STATUS(CODE_NAME,110);
     exit;
  end;
...
l.add('/usr/share/perl/5.10.0/spamassassin-run.pod');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/AICache.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/ArchiveIterator.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/AsyncLoop.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/AutoWhitelist.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Bayes.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/BayesStore.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Client.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Conf.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Constants.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/DBBasedAddrList.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Dns.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/DnsResolver.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/HTML.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Locales.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Locker.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Logger.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/MailingList.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Message.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/NetSet.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/PerMsgLearner.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/PerMsgStatus.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/PersistentAddrList.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/PluginHandler.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Reporter.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/SQLBasedAddrList.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/SpamdForkScaling.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/SubProcBackChannel.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Timeout.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Util.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Bayes/CombineChi.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Bayes/CombineNaiveBayes.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/BayesStore/BDB.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/BayesStore/DBM.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/BayesStore/MySQL.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/BayesStore/PgSQL.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/BayesStore/SDBM.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/BayesStore/SQL.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Conf/LDAP.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Conf/Parser.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Conf/SQL.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Locker/Flock.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Locker/UnixNFSSafe.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Locker/Win32.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Logger/File.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Logger/Stderr.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Logger/Syslog.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Message/Metadata');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Message/Metadata.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Message/Node.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Message/Metadata/Received.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/ASN.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/AWL.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/AccessDB.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/AntiVirus.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/AutoLearnThreshold.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/Bayes.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/BodyEval.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/BodyRuleBaseExtractor.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/Check.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/DCC.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/DKIM.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/DNSEval.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/FreeMail.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/HTMLEval.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/HTTPSMismatch.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/Hashcash.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/HeaderEval.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/ImageInfo.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/MIMEEval.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/MIMEHeader.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/OneLineBodyRuleType.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/PhishTag.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/Pyzor.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/Razor2.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/RelayCountry.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/RelayEval.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/ReplaceTags.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/Reuse.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/Rule2XSBody.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/SPF.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/Shortcircuit.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/SpamCop.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/Test.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/TextCat.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/URIDNSBL.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/URIDetail.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/URIEval.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/VBounce.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/WLBLEval.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Plugin/WhiteListSubject.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Util/DependencyInfo.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Util/Progress.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Util/RegistrarBoundaries.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Util/ScopedTimer.pm');
l.add('/usr/share/perl/5.10.0/Mail/SpamAssassin/Util/TieOneStringHash.pm');
l.add('/usr/share/perl5/Mail/SpamAssassin/Plugin/DomainKeys.pm');
l.add('/var/lib/spamassassin/compiled/5.010/3.003001/Mail/SpamAssassin/CompiledRegexps/body_0.pm');
l.add('/var/lib/spamassassin/compiled/5.010/3.003001/auto/Mail/SpamAssassin/CompiledRegexps/body_0/.packlist');
l.add('/var/lib/spamassassin/compiled/5.010/3.003001/auto/Mail/SpamAssassin/CompiledRegexps/body_0/body_0.bs');
l.add('/var/lib/spamassassin/compiled/5.010/3.003001/auto/Mail/SpamAssassin/CompiledRegexps/body_0/body_0.so');
...
for i:=0 to l.Count-1 do begin
   if FileExists(l.Strings[i]) then begin
      ...
      // writeln('removing '+l.Strings[i]+' no such file');
   end;
end;
