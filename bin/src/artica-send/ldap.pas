...
D:=COMMANDLINE_PARAMETERS('debug');
 ...
 //######################################################################################
function Tldap.mailman_ou(distri:string):string;
var
   l:TStringList;
   i,t:integer;
...
//##############################################################################
function Tldap.SearchResults_single(SearchResults:TLDAPResultList;WhatToFind:string):string;
var
   i,t:Integer;
   AttributeNameQ:string;
...
//##############################################################################
function Tldap.SearchResults_multiple(SearchResults:TLDAPResultList;WhatToFind:string):TstringList;
var
   i,t,u:Integer;
   AttributeNameQ:string;
   k:TstringList;
