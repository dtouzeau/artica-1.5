unit artica_send_logs;
{$mode objfpc}{$H+}

interface

uses
Classes, SysUtils,variants, Process,IniFiles,BaseUnix,unix,md5,RegExpr in 'RegExpr.pas';
...
public
    ...
    PROCEDURE ArticaSend(zText:string);
    PROCEDURE ArticaSendSql(zText:string);
...
PROCEDURE Tlogs.ArticaSendSql(zText:string);
      var
        zDate:string;
        myFile : TextFile;
        xText:string;
      ...
      BEGIN
        ...
        TargetPath:='/var/log/artica-postfix/artica-send.' + maintenant_day + '-' + maintenant_day_hour+'.sql.log';
        xText:=zDate + ' [' + PID + '] ' + zText;
        TRY
...
//##############################################################################
PROCEDURE Tlogs.ArticaSend(zText:string);
      var
        zDate:string;
        myFile : TextFile;
        xText:string;
      ...
      BEGIN
        ...
        TargetPath:='/var/log/artica-postfix/artica-send.' + maintenant_day + '-' + maintenant_day_hour+'.log';
        xText:=zDate + ' [' + PID + '] ' + zText;
        TRY
