...
if not FileExists('/opt/kav/5.6/kavmilter/bin/kavmilter') then begin
   source_folder:=libs.COMPILE_GENERIC_APPS('kavmilter');
  ...
  fpsystem('/opt/kav/5.6/kavmilter/bin/kavmilter-setup.sh -trial-key /usr/share/artica-postfix/bin/install/MLX_00BD2B2E_081231.key');
