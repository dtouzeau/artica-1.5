...
//#########################################################################################
procedure tfreebsd.Show_Welcome;
var
   base,postfix,u,cyrus,samba,squid:string;
begin
    if not FileExists('/usr/sbin/pkg_add') then begin
      writeln('Your system does not store pkg utils, this program must be closed...');
      halt(0);
    end;
...
//#########################################################################################
function tfreebsd.uninstall_app_armor():boolean;
var
   u:string;
begin
result:=false;
...
//#########################################################################################
function tfreebsd.InstallPackageLists(list:string):boolean;
var
   cmd:string;
      u:string;
begin
...
//#########################################################################################
function tfreebsd.is_application_installed(appname:string):boolean;
var
   l:TstringList;
   RegExpr:TRegExpr;
   i:integer;
begin
    ...
    if not FileExists('/tmp/packages.list') then begin
       fpsystem('/usr/sbin/pkg_info >/tmp/packages.list');
    end;
...
//#########################################################################################
function tfreebsd.CheckBaseSystem():string;
var
   l:TstringList;
   f:string;
   i:integer;
...
//#########################################################################################
function tfreebsd.CheckPostfix():string;
var
   l:TstringList;
   f:string;
   i:integer;
...
//#########################################################################################
function tfreebsd.CheckCyrus():string;
var
   l:TstringList;
   f:string;
   i:integer;
...
//#########################################################################################
function tfreebsd.checkSamba():string;
var
   l:TstringList;
   f:string;
   i:integer;
...
//#########################################################################################
function tfreebsd.checkSQuid():string;
var
   l:TstringList;
   f:string;
   i:integer;
...
//########################################################################################
procedure tfreebsd.InstallArtica();
var
   my:TiniFile;
...
//########################################################################################
function tfreebsd.WGET_DOWNLOAD_FILE(uri:string;file_path:string):boolean;
var
   RegExpr:TRegExpr;
   ProxyString:string;
   ProxyCommand:string;
...
//##############################################################################
function  tfreebsd.GET_HTTP_PROXY:string;
var
   l:TStringList;
   i:integer;
   RegExpr:TRegExpr;
...
//##############################################################################
function tfreebsd.LOCATE_CURL():string;
begin
 ...
 //#############################################################################
 procedure  tfreebsd.SET_HTTP_PROXY(proxy_string:string);
var
   l:TStringList;
   i:integer;
   RegExpr:TRegExpr;
...
//##############################################################################
//##############################################################################
function  tfreebsd.REMOVE_HTTP_PROXY:string;
var
   l:TStringList;
   i:integer;
   RegExpr:TRegExpr;
...
//##############################################################################
function tfreebsd.get_LDAP(key:string):string;
var
   value:string;
   Ini:TMemIniFile;
...
//#############################################################################
procedure tfreebsd.set_LDAP(key:string;val:string);
var ini:TIniFile;
begin
...
//#############################################################################
function tfreebsd.ARTICA_VERSION():string;
var
   l:string;
   F:TstringList;
...
//#############################################################################
//#############################################################################
function tfreebsd.get_LDAP_ADMIN():string;
var
   RegExpr:TRegExpr;
   l:TstringList;
   i:integer;
...
//#############################################################################
function tfreebsd.get_LDAP_PASSWORD():string;
var
   RegExpr:TRegExpr;
   l:TstringList;
   i:integer;
...
//#############################################################################
function tfreebsd.get_LDAP_suffix():string;
var
   RegExpr:TRegExpr;
   l:TstringList;
   i:integer;
...
//#############################################################################
function tfreebsd.SLAPD_CONF_PATH():string;
begin
