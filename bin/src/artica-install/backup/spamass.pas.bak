...
begin
       ...
       if not TryStrToInt(SYS.GET_INFO('EnableSPF'),EnableSPF) then EnableSPF:=1;
...
if EnableAmavisDaemon=1 then exit(1);
...
//#########################################################################################
procedure Tspamass.SPAMASSASSIN_V320();
var filename:string;
    l:Tstringlist;
begin
 filename:='/etc/spamassassin/v320.pre';
 if FileExists(filename) then exit;
 l:=Tstringlist.Create;
 l.Add('loadplugin Mail::SpamAssassin::Plugin::Check');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::HTTPSMismatch');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::URIDetail');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::Bayes');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::BodyEval');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::DNSEval');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::HTMLEval');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::HeaderEval');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::MIMEEval');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::RelayEval');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::URIEval');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::WLBLEval');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::ImageInfo');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::AWL');
 logs.WriteToFile(l.Text,filename);
 logs.Debuglogs('Starting......: spamassassin v320.pre success');
 l.free;
end;
//#########################################################################################
...
begin
 ...
 l.Add('loadplugin Mail::SpamAssassin::Plugin::URIDNSBL');
 l.Add('loadplugin Mail::SpamAssassin::Plugin::Hashcash');
 if EnableSPF=1 then begin
    l.Add('loadplugin Mail::SpamAssassin::Plugin::SPF');
