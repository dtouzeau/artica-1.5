...
begin
result:=SYS.LOCATE_AWSTATS_BIN_PATH();
end;
...
begin
if DirectoryExists('/usr/local/awstats/wwwroot/icon')  then exit('/usr/local/awstats/wwwroot');
...
if DirectoryExists('/usr/share/awstats/wwwroot/icon')  then exit('/usr/share/awstats/wwwroot');
end;
//#############################################################################
