...
_setDropAjax:function(newParentObj,asSibling,copydrag){
try{
this._setWaitImg(this,true);
...
if(cdrag){
cdragId=this.id+this.tree.copyNameBreak+this.tree.idTree;
...
ok=dragObj.struct.ondrop(dragObj,this,false,null);
}
if(ok){
...
dragObj._setDropAjax(this,asSibling,copyDrag);
} else{
var newBranch=null;
if(!asSibling){
if(!copyDrag){
...
if(typeof(dragObj.struct.ondrop)== 'function'){
ok=dragObj.struct.ondrop(dragObj,this,true,newBranch);
}
}
}
},
