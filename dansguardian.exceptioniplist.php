...
<tr>
		...
		<td width=99%><center>". Field_text("IpWhite",null,"padding:3px;margin:3px;font-size:13px",null,null,null,false,"SelectDansGuardianExceptionipList(event)")."</center></td>
		<td width=1%>". imgtootltip("plus-24.png","{add}","SelectDansGuardianExceptionipListButton()")."</td>
</tr>
</table>
<table style='width:100%'>
<tr>
...
<thead class='thead'>
	<tr>
		<th colspan=4>{white_ip_group}$mysql_error</th>
	</tr>
</thead>
<tbody class='tbody'>";	
...
function AddDansGuardianExceptionipList(){
	...
	$uid=$_GET["uid"];
	if(!$dans->Add_exceptioniplist($_GET["AddDansGuardianExceptionipList"],$_GET["AddDansGuardianExceptionipList"],$uid,1)){
		echo $dans->error;
	}
