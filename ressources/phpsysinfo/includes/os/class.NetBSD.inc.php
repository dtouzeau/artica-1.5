...
***************************************************************************/
//
// $Id: class.NetBSD.inc.php,v 1.23 2008/06/05 18:42:30 bigmichi1 Exp $
//
...
class sysinfo extends bsd_common {
  ...
  public function __construct() {
    ...
    $this->set_cpuregexp2("/user = (.*), nice = (.*), sys = (.*), intr = (.*), idle = (.*)/");
    $this->set_scsiregexp1("^(.*) at scsibus.*: <(.*)> .*");
    $this->set_scsiregexp2("^(da[0-9]): (.*)MB ");
    $this->set_pciregexp1("/(.*) at pci[0-9] dev [0-9]* function [0-9]*: (.*)$/");
