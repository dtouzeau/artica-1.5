...
function TimeEntry() {
	...
	this._defaults = {
		...
		spinnerImage: '/img/spinnerUpDownBig.png', // The URL of the images to use for the time spinner
			// Seven images packed horizontally for normal, each button pressed, and disabled
		spinnerSize: [20, 23, 0], // The width and height of the spinner image,
			// and size of centre button for current time
		spinnerBigImage: '', // The URL of the images to use for the expanded time spinner
			// Seven images packed horizontally for normal, each button pressed, and disabled
		spinnerBigSize: [20, 23, 10], // The width and height of the expanded spinner image,
			// and size of centre button for current time
